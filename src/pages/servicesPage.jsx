...
const servicesData = [
  {
    id: 1,
    icon: <MdDesignServices className="text-[70px] mb-[20px] text-primary" />,
    title: "Web Developer",
  ...
  {
    id: 2,
    icon: <IoIosRocket className="text-[70px] mb-[20px] text-primary" />,
  ...
  {
    id: 3,
    icon: <FaCode className="text-[70px] mb-[20px] text-primary" />,
    title: "Clean Code",
    ...
    <section className="services" id="services">
      ...
      <div className="container flex justify-between items-center flex-wrap">
        {servicesData.map((s) => (
          <article
            key={s.id}
            className="card items-start w-full mb-10 md:w-[48%] lg:w-[31%] lg:mb-0 py-[50px] px-[40px]"
          >
            {s.icon}
            <h3 className="mb-[20px]">{s.title}</h3>
