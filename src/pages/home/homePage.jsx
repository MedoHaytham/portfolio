...
function HomePage() {
  return (
    <div className='home h-auto py-20 md:h-[100vh] md:pt-[100px] capitalize overflow-hidden'>
      <div className="container h-full text-center relative">
        ...
        <div className="links text-[25px] flex md:flex-col justify-center items-center gap-5 md:absolute xl:bottom-[50px] md:after:content-[''] md:after:w-[1px] md:after:h-8 md:after:bg-primary">
